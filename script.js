...
function displayContacts(contacts){
    ...
    if (!contacts || contacts.length === 0) {
        contactList.innerHTML = '<div class="loading">No contacts found. Add your first contact</div>';
        return;
    }
            ...
            html += `
                    <div class="contact-card">
                        ...
                        <div class="contact-actions">
                            <button class="btn btn-secondary" onclick="showEditContacts('${contact.id}')">Edit</button>
